...
Private Sub LoadNameSource()
        ...
        Leer.Initialize DirExtras & "Obj2.dat"
        tmpCant = Val(Leer.GetValue("Init", "NumOBJ"))
        
        ReDim Obj(1 To tmpCant) As tNames

        For LoopC = 1 To tmpCant
                Obj(LoopC).Nombre = Leer.GetValue("Objeto" & LoopC, "Name")
                Obj(LoopC).GrhIndex = Val(Leer.GetValue("Objeto" & LoopC, "GrhIndex"))
                
                Obj(LoopC).ObjType = Val(Leer.GetValue("Objeto" & LoopC, "ObjType"))
                Obj(LoopC).Valor = Val(Leer.GetValue("Objeto" & LoopC, "Valor"))
                  
                Obj(LoopC).MinHit = Val(Leer.GetValue("Objeto" & LoopC, "MinHit"))
                Obj(LoopC).MaxHit = Val(Leer.GetValue("Objeto" & LoopC, "MaxHit"))
        
                Obj(LoopC).MinDef = Val(Leer.GetValue("Objeto" & LoopC, "MinDef"))
                Obj(LoopC).MaxDef = Val(Leer.GetValue("Objeto" & LoopC, "MaxDef"))
        
                Obj(LoopC).DefensaMagicaMin = Val(Leer.GetValue("Objeto" & LoopC, "DefensaMagicaMin"))
                Obj(LoopC).DefensaMagicaMax = Val(Leer.GetValue("Objeto" & LoopC, "DefensaMagicaMax"))
                
                Obj(LoopC).LingH = Val(Leer.GetValue("Objeto" & LoopC, "LingH"))
                Obj(LoopC).LingP = Val(Leer.GetValue("Objeto" & LoopC, "LingP"))
                Obj(LoopC).LingO = Val(Leer.GetValue("Objeto" & LoopC, "LingO"))
        
                Obj(LoopC).Upgrade = Val(Leer.GetValue("Objeto" & LoopC, "Upgrade"))
                Obj(LoopC).Madera = Val(Leer.GetValue("Objeto" & LoopC, "Madera"))
                Obj(LoopC).MaderaElfica = Val(Leer.GetValue("Objeto" & LoopC, "MaderaElfica"))
...
Private Sub LoadInitialConfig()
        ...
        If Not InitTileEngine(frmMain.hWnd, 145, 12, 32, 32, 13, 17, 9, 8, 8, 0.018) Then
                Call CloseClient
