        ...
        If Left$(Comando, 1) = "/" Then
                ...
                End If
                        ...
                        Case "/PROMEDIO"
                                ...
                                ' @@ UserMaxHp - 21(Vida Inicial)
                                ' @@ UserLvl -1 (Ignoramos el nivel 1)
                                
                                Prom = FormatNumber(UserMaxHP / (UserLvl), 2)
                                Call ShowConsoleMsg("Tu promedio de vida es de:" & Prom & ".", 255, 255, 255, True)
                                
                                'With FontTypes(FontTypeNames.FONTTYPE_GUILDMSG)
                                '     Call ShowConsoleMsg("Promedio de tu Personaje: " & (UserMaxHP / UserLvl), .red, .green, .blue, 1)
                                'End With
