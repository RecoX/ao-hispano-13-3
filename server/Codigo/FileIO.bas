...
Sub LoadUserInit(ByVal UserIndex As Integer, ByRef UserFile As clsIniManager)
        ...
        With UserList(UserIndex)
                ...
                .clave = UserFile.GetValue("CONTACTO", "Clave")
...
Sub SaveUser(ByVal UserIndex As Integer, _
        ...
        With UserList(UserIndex)
                ...
                Call Manager.ChangeValue("CONTACTO", "Clave", .clave)
                ...
                Call Manager.ChangeValue("MERCADO", "POSTEADO", .flags.Posteado)
                Call Manager.ChangeValue("MERCADO", "MEMANDO", .flags.MeMando)
                Call Manager.ChangeValue("MERCADO", "LEMANDE", .flags.Lemande)
